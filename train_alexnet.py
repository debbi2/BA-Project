...
def evaluate(model, val_loader, criterion, epoch, total_epoch, log_step, min_loss):
	...
	if running_loss < min_loss:
		torch.save(model.state_dict(),"best_model_alexnet_{}.save".format(data_choice))
...
plt.xlabel('Epochs')
plt.legend()
plt.savefig('Loss_Metrics_alexnet_{}.jpg'.format(data_choice))
...
plt.xlabel('Epochs')
plt.legend()
plt.savefig('Accuracy_Metrics_alexnet_{}.jpg'.format(data_choice))
##################################################
